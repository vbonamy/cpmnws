...
@RequestMapping("/cpmnpersos")
@Controller
@RooWebScaffold(path = "cpmnpersos", formBackingObject = CpmnPerso.class, create = false, delete = false, update = false)
@RooWebFinder
public class CpmnPersoController {
}
